<div class="status-check-container bg-white p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 rounded-lg shadow-lg max-w-7xl mx-auto my-8 border border-gray-200">
    ...
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const locker_name = popup.querySelector('#locker_name').value;
            const building = popup.querySelector('#building').value;
            const floor = popup.querySelector('#floor').value;
